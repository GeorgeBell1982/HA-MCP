...
1. Record confirmed target and deployment choice: Home Assistant OS 18.1, Core 2026.7.1, Supervisor 2026.06.2, Raspberry Pi 5 `aarch64`, purpose-built managed add-on, mapped `/config`, storage-mode dashboards.
