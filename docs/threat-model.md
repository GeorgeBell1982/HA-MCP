...
| DNS rebinding/forged proxy/CSRF              | Explicit Host allowlist, Origin policy, separate ingress listener bound internally but without a host port and reachable only through authenticated HA ingress, ignore forwarded headers otherwise, query credentials forbidden.                                       |
